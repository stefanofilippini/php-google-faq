...
<body>
    <header class="container">
        <div class="d-flex align-items-center justify-content-between mb-2 headerone">
        ...
        <div class="d-flex links mb-4 border justify-content-between align-items-center">
            <?php
                foreach($links as $link) {
                    echo "<span class='link me-3' tabindex='0'>" . $link . "</span>";
                }
            ?>
        </div>
    </header>
